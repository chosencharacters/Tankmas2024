...
class TankmasClient
{
	static var address:String = #if host_address 'https://${haxe.macro.Compiler.getDefine("host_address")}' #elseif test_local 'http://127.0.0.1:5000' #else "https://tankmas.kornesjo.se:25567" #end;
